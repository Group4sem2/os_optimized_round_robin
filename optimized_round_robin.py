        ...
        while 1:
            ...
            if len(ready_queue) != 0:
                if ready_queue[0][2] > time_slice:
                    ...
                    if(process_data[j][2]<time_slice):
                        ready_queue.pop(0)
                        sedond_ready_queue.append(process_data[j])
                        if(len(sedond_ready_queue)==2):
                            for isr in range(2):
                                start_time.append(s_time)
                                s_time = s_time + sedond_ready_queue[isr][2]
                                e_time = s_time
                                exit_time.append(e_time)
                                executed_process.append(sedond_ready_queue[isr][0])
                                for z in range(len(process_data)):
                                    if process_data[j][0] == sedond_ready_queue[isr][0]:
                                        break
                                process_data[z][2] = 0
                                process_data[z][3] = 1
                                process_data[z].append(e_time)
                    else :
                      ready_queue.pop(0)
                    ...
                    if(process_data[j][2]<time_slice):
                        ...
                        if(len(sedond_ready_queue)==2):
                            for isr in range(2):
                                ...
                                executed_process.append(sedond_ready_queue[isr][0])
                                for z in range(len(process_data)):
                                    if process_data[z][0] == sedond_ready_queue[isr][0]:
                                        break
                                process_data[z][2] = 0
                                process_data[z][3] = 1
                                process_data[z].append(e_time)
